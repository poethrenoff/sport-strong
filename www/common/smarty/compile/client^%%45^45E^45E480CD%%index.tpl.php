<?php /* Smarty version 2.6.22, created on 2013-07-01 22:50:29
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'index.tpl', 5, false),)), $this); ?>
<!DOCTYPE html>
...
(916) 810 09 02<br>(495) 778 66 59
    ...
    <div id="body">
        ...
        <div id="left">
            ...
            <!--noindex--><?php echo $this->_tpl_vars['menu']; ?>
<!--/noindex-->
			</div><!-- # leftmenubox-->
            <!-- news box -->
            <!--noindex--><?php echo $this->_tpl_vars['news']; ?>
<!--/noindex-->
            <!-- # news box -->
        ...
        <div id="right">
        	...
        	<!-- slide box -->
			<?php if ($this->_tpl_vars['main_page_flag'] == 1): ?>
            <div class="slidebox">
            ...
            <!-- tabs -->
            <div class="tabsbox">
				<?php echo $this->_tpl_vars['output_marker_list']; ?>
            ...
            <div class="brands">
				...
				<ul>
					<?php $_from = $this->_tpl_vars['brand_list_1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['mas_1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['mas_1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['mas_1']['iteration']++;
?>
						<li><a href="/catalogue.php?catalogue_id=0&product_brand=<?php echo $this->_tpl_vars['item']['brand_id']; ?>
"><?php echo $this->_tpl_vars['item']['brand_title']; ?>
</a></li>
					<?php endforeach; endif; unset($_from); ?>					
				</ul>
				
				<ul>
					<?php $_from = $this->_tpl_vars['brand_list_2']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['mas_2'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['mas_2']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item2']):
        $this->_foreach['mas_2']['iteration']++;
?>
						<li><a href="/catalogue.php?catalogue_id=0&product_brand=<?php echo $this->_tpl_vars['item2']['brand_id']; ?>
"><?php echo $this->_tpl_vars['item2']['brand_title']; ?>
</a></li>
					<?php endforeach; endif; unset($_from); ?>					
				</ul>
				
				<ul>
					<?php $_from = $this->_tpl_vars['brand_list_3']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['mas_3'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['mas_3']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item3']):
        $this->_foreach['mas_3']['iteration']++;
?>
						<li><a href="/catalogue.php?catalogue_id=0&product_brand=<?php echo $this->_tpl_vars['item3']['brand_id']; ?>
"><?php echo $this->_tpl_vars['item3']['brand_title']; ?>
</a></li>
					<?php endforeach; endif; unset($_from); ?>					
				</ul>
				<ul>
					<?php $_from = $this->_tpl_vars['brand_list_4']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['mas_4'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['mas_4']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item4']):
        $this->_foreach['mas_4']['iteration']++;
?>
						<li><a href="/catalogue.php?catalogue_id=0&product_brand=<?php echo $this->_tpl_vars['item4']['brand_id']; ?>
"><?php echo $this->_tpl_vars['item4']['brand_title']; ?>
</a></li>
					<?php endforeach; endif; unset($_from); ?>					
				</ul>		 		
...
<?php if ($this->_tpl_vars['main_page_flag'] == 1): ?><div class="content_place"><?php else: ?><div><?php endif; ?>
